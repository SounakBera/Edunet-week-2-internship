...
└── cars\_data\_cleaned.csv \# (Required for training \- not included)
...
Make sure you have the dataset named cars\_data\_cleaned.csv in the same directory. This file is required by train\_model.py.

*(Note: This dataset is not included in this repository.)*

### **2\. Run the Training Script**

Execute the train\_model.py script. This will load the CSV, train a new RandomForestRegressor pipeline (including a StandardScaler), and save the new model over the old model.pkl file.
